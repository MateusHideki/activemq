...
public class TesteProdutorTopic {
	...
	public static void main(String[] args) throws Exception {
		...
		// A Session no JMS abstrai o trabalho transacional e confirmação do recebimento
		// da mensagem.
		Session session = connection.createSession(false, Session.AUTO_ACKNOWLEDGE);

		// é o local concreto no qual a mensagem ira ser salva temporariamente. No caso
		// uma fila teste.
...
//		Message message = session.createTextMessage("testandoAGora");
		...
		// criando uma propriedade na mensagem para identificar quais são os
		// consumidores alvo.
